<%@ Page Title="" Language="C#" MasterPageFile="~/masuta.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="DaftarKlien.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style5">
        <tr>
            <td>
        <asp:TextBox ID="txtCari" runat="server" Width="240px"></asp:TextBox>
            </td>
            <td>
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="margin-left: 184px; height: 26px;" Text="Cari" />
            </td>
        </tr>
        <tr>
            <td>
    ...
    <p>
        ...
        <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" style="margin-left: 239px" Text="Edit" />
    <p>
        &nbsp;</p>
    <p>
        &nbsp;</p>
    <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="id" ForeColor="#333333" GridLines="None" style="margin-left: 472px" AllowPaging="True">
